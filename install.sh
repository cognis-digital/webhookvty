#!/usr/bin/env sh
# Universal installer for webhookvty. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/webhookvty.git"
echo "Installing webhookvty ..."
